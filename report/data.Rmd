...
In order to compare the GDP per person and calorie consumption per person, we will create a separate table which we will join to the final clean dataset.
