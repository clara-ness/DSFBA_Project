...
## Plotting Diabetes against each type of calories consumption (without outliers)

Now we want to see if we have different trends when we remove our 5 outliers: 
