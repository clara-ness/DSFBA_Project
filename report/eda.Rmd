...
```
There do not seem to be any trends in the graphs above and calorie consumption is rather stable in each country which is why we will take the average consumption for each macro-nutrients.
We can however note that the 5 front outliers have a higher fat consumption than the countries with a smaller GDP. 
