...
However, we see that apart of 5 outliers, our observations are mostly bunched up at the left of the graph. We decided to exclude these 5 observations, which are the richest countries, to see if we can observe a trend.
