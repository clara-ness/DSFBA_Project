...
Now let's see if there is a relation between the GDP of a country and its diabetes prevalence.
...
Now we want to see the diabetes prevalence against the total calories consumption and also against each type calories consumed:
