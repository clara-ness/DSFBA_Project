...
################################
ggplot() + 
  geom_line(data = GDP_diabetes_cal_pp, aes(x = GDP_per_person, y = total_consumption), color = "orange") +
  geom_smooth(mapping = aes(x = GDP_diabetes_cal_pp$GDP_per_person, y=GDP_diabetes_cal_pp$total_consumption), color = "orange", method = "lm") +
  labs(x = "GDP per capita", y= "Calories")

ggplot() + 
  geom_line(data = GDP_diabetes_cal_pp, aes(x = GDP_per_person, y = cal_fat), color = "blue") +
  geom_smooth(mapping = aes(x = GDP_diabetes_cal_pp$GDP_per_person, y=GDP_diabetes_cal_pp$cal_fat), color = "blue", method = "lm") +
  labs(x = "GDP per capita", y= "Calories from fat")

ggplot() +
  geom_line(data = GDP_diabetes_cal_pp, aes(x = GDP_per_person, y = cal_carbs), color = "purple") +
  geom_smooth(mapping = aes(x = GDP_diabetes_cal_pp$GDP_per_person, y=GDP_diabetes_cal_pp$cal_carbs), color = "purple", method = "lm") +
  labs(x = "GDP per capita", y= "Calories from carbs")

ggplot() +
  geom_line(data = GDP_diabetes_cal_pp, aes(x = GDP_per_person, y = cal_prot_animal), color = "red") +  
  geom_smooth(mapping = aes(x = GDP_diabetes_cal_pp$GDP_per_person, y=GDP_diabetes_cal_pp$cal_prot_animal), color = "red", method = "lm") +
  labs(x = "GDP per capita", y= "Calories from animal protein")

ggplot() +
  geom_line(data = GDP_diabetes_cal_pp, aes(x = GDP_per_person, y = cal_prot_plant), color = "green") +
  geom_smooth(mapping = aes(x = GDP_diabetes_cal_pp$GDP_per_person, y=GDP_diabetes_cal_pp$cal_prot_plant), color = "green", method = "lm") +
