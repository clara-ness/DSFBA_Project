...
In general, though it seems positive, we cannot conclude that there is a strong correlation between the wealth of a country and its animal protein consumption.
...
We see that the correlations within clusters is weaker. And actually, even in countries with lower GDPs that belong to cluster 2, the relationship is rather negative. This indicates us that visual interpretation is not enough for analysis.
...
This could maybe be explained by the fact that variance is very high at the left part of the graph where the average GDP is lower. --> if correlation low
