...
c0 <- matrix(c(cor(GDP_diabetes_cal2$avg_gdp, GDP_diabetes_cal2$prop_women_diabetes), cor(GDP_diabetes_cal2$avg_gdp, GDP_diabetes_cal2$prop_men_diabetes)))

rownames(c0) <- c("Between avg_gdp and women diabetes", "Between avg_gdp and men diabetes")

kbl(c0,
   caption = "**Corrolation without outliers",
   align = c('cccccc')) %>%
...
kbl(c1,
   caption = "**Corrolation for cluster 1",
   align = c('cccccc')) %>%
   kable_classic(full_width = T, html_font = "Cambria") %>%
   kable_styling(bootstrap_options = c('striped', 'hover', 'condensed')) 
...
kbl(c2,
   caption = "**Corrolation for cluster 2",
   align = c('cccccc')) %>%
   kable_classic(full_width = T, html_font = "Cambria") %>%
   kable_styling(bootstrap_options = c('striped', 'hover', 'condensed')) 
...
kbl(c3,
   caption = "**Corrolation for cluster 3",
   align = c('cccccc')) %>%
   kable_classic(full_width = T, html_font = "Cambria") %>%
   kable_styling(bootstrap_options = c('striped', 'hover', 'condensed')) 
