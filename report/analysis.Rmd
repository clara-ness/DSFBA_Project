...
rownames(c0) <- c("Between average GDP and women diabetes rate", "Between average GDP and men diabetes rate")
...
tab_model(
  lm_gdp_diabetes_women,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Women diabetes rate"),
  CSS = list(
    css.width = "800px",
...
tab_model(
  lm_gdp_diabetes_men,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Men diabetes rate"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c_out) <- c("Between average GDP and women diabetes rate", "Between average GDP and men diabetes rate")
...
```{r}
tab_model(
  lm_gdp_diabetes_women2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Women diabetes rate </n> (without outliers"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
```{r}
tab_model(
  lm_gdp_diabetes_men2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Men diabetes rate </n> (without outliers"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
We therefore see from the graph above that the optimal number of clusters is 3. When using the k-means method, the allocation of countries according to their cluster is as follows:
...
To go further, we decided to represent these clusters on a map. 
<br>
```{r, warning=FALSE}
...
We can see that the first cluster is located more in the north and center of Europe while the second cluster is more towards the extremities (West and East). We can ask ourselves what differentiates these eastern and western countries of Europe. For this we will look at how diabetes is distributed geographically.

```{r}
pal <- colorNumeric(
  palette = "YlGnBu",
  domain = CL_EU$prop_men_diabetes
)
...
leaflet(SHP_0) %>%
  ...
  addLegend("bottomright",
    pal = pal, values = ~ CL_EU$prop_men_diabetes,
    title = "Men Diabetes",
    opacity = 1
  )
```

On the map, we can see that diabetes is mainly located in the south of Europe and precisely at the eastern and western ends. Do we get the same result for women?
<br><br>
```{r}
pal <- colorNumeric(
  palette = "YlGnBu",
  domain = CL_EU$prop_women_diabetes
)
...
leaflet(SHP_0) %>%
  ...
  addPolygons(
    stroke = FALSE, smoothFactor = 0.2, fillOpacity = 1,
    color = ~ pal(CL_EU$prop_women_diabetes)
  ) %>%
  addLegend("bottomright",
    pal = pal, values = ~ CL_EU$prop_women_diabetes,
    title = "Women Diabetes",
    opacity = 1
  )
```

Women with diabetes seem to be mainly located in the eastern and south-western regions of Europe, which corresponds to the countries of cluster 2 that have a higher diabetes rate. 
<br><br>
```{r}
pal <- colorNumeric(
  palette = "YlGnBu",
...
leaflet(SHP_0) %>%
  ...
  addLegend("bottomright",
    pal = pal, values = ~ CL_EU$avg_gdp,
    title = "Average GDP",
    opacity = 1
  )
```

We observe that the countries that are in cluster 2 have a lower GDP. Let's see if we can reaffirm this claim with a cluster plot.  
<br><br>
```{r, warning=FALSE}
...
rownames(c1) <- c("Between average GDP and women diabetes rate", "Between average GDP and men diabetes rate")
...
```{r}
tab_model(
  lm_gdp_diabetes_women_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Women diabetes rate (cluster 1)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c2) <- c("Between average GDP and women diabetes rate", "Between average GDP and men diabetes rate")
...
```{r}
tab_model(
  lm_gdp_diabetes_women_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Women diabetes (cluster 2)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
```{r}
tab_model(
  lm_gdp_diabetes_men_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Men diabetes (cluster 2)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c3) <- c("Between average GDP and women diabetes rate", "Between average GDP and men diabetes rate")
...
tab_model(
  lm_gdp_diabetes_women_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Women diabetes (cluster 3)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_gdp_diabetes_men_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs Men diabetes (cluster 3)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c4) <- c("Between average GDP and total calories")
...
tab_model(
  lm_gdp_total_cal,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs total consumption"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c5) <- c("Between GDP per person and total calories")
...
tab_model(
  lm_gdp_pp_total_cal,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("GDP per person vs total consumption"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c6) <- c("Between GDP per person and total calories")
...
tab_model(
  lm_gdp_total_cal_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("GDP per person vs total consumption (cluster 1)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c7) <- c("Between GDP per person and total calories")
...
tab_model(
  lm_gdp_total_cal_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("GDP per person vs total consumption (cluster 2)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c8) <- c("Between GDP per person and total calories")
...
tab_model(
  lm_gdp_total_cal_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("GDP per person vs total consumption (cluster 3)"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
## How do the macronutrients (animal protein/plant protein/carbohydrates/fat) consumed differ between richer and poorer countries ?
...
rownames(c9) <- c("Between average GDP and calories from animal protein")
...
tab_model(
  lm_gdp_cal_prot_animal,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Average GDP vs calories from animal protein"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_gdp_pp_prop_animal_prot_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between GDP per person and proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_gdp_pp_prop_animal_prot_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between GDP per person and proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_gdp_pp_prop_animal_prot_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between GDP per person and proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
For each cluster, the correlation is positive and relatively strong, but only the estimate of the parameter for cluster 2 is significant.

In general, we could conclude that there is a positive link between the wealth of a country and its animal protein consumption.
...
rownames(c15) <- c("Between average GDP and calories from plant protein")
...
tab_model(
  lm_gdp_cal_prot_plant,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between average GDP and calories from plant protein"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_gdp_pp_prop_plant_prot_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between GDP per person and proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_gdp_pp_prop_plant_prot_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between GDP per person and proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_gdp_pp_prop_plant_prot_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between GDP per person and proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
So overall, we could conclude that there is a negative relationship between the wealth of a country and its plant protein consumption.
...
rownames(c21) <- c("Between average GDP and calories from carbs")
...
tab_model(
  lm_gdp_cal_carbs,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between average GDP and calories from carbs"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
Surprisingly, with these correlations we see that the previous logic is inversed within clusters. For richer countries like those in cluster 1 and 3 the link between GDP and carbs consumption is positive within their respective clusters, and for less rich countries like in those in cluster 2, it is negative. The estimate for the model parameter for cluster 2 is even very significant.

Though in general, we could conclude that the link between the wealth of a country and its carb consumption is negative.
...
rownames(c27) <- c("Between average GDP and calories from fat")
...
tab_model(
  lm_gdp_cal_fat,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Between average GDP and calories from fat"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
Therefore, we could say by looking at the overall results that there is a positive link between the wealth of a country and its fat consumption.


## How do these differences in macronutrients relate to the diabetes prevalence in these countries ? What is the typical diet that can be observed in richer states that relates to lower diabetes prevalence ?
...
c400 <- matrix(c(cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$cal_prot_animal), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$cal_prot_animal), cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$cal_prot_plant), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$cal_prot_plant), cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$cal_carbs), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$cal_carbs), cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$cal_fat), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$cal_fat)), nrow = 2)

rownames(c400) <- c("Men", "Women")

colnames(c400) <- c("Animal protein", "Plant protein", "Carbs", "Fat")

kbl(c400,
  caption = "**Correlation between diabetes rate per sex and calories from**",
  align = c("cccccc")
) %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
...
c401 <- matrix(c(cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$proportion_animal_prot), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$proportion_animal_prot), cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$proportion_plant_prot), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$proportion_plant_prot), cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$proportion_carbs), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$proportion_carbs), cor(GDP_diabetes_cal$prop_men_diabetes, GDP_diabetes_cal$proportion_fat), cor(GDP_diabetes_cal$prop_women_diabetes, GDP_diabetes_cal$proportion_fat)), nrow = 2)

rownames(c401) <- c("Men", "Women")

colnames(c401) <- c("Animal protein", "Plant protein", "Carbs", "Fat")

kbl(c401,
  caption = "**Correlation between diabetes rate per sex and proportion of calories from**",
  align = c("cccccc")
) %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
...
tab_model(
  lm_diabm_prop_animal_prot,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_diabw_prop_animal_prot,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c50) <- c("Between men diabetes rate and proportion of calories from animal protein", "Between women diabetes rate and proportion of calories from animal protein")
...
tab_model(
  lm_diabm_prop_animal_prot_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabw_prop_animal_prot_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
rownames(c51) <- c("Between men diabetes rate and proportion of calories from animal protein", "Between women diabetes rate and proportion of calories from animal protein")
...
tab_model(
  lm_diabm_prop_animal_prot_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabw_prop_animal_prot_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
rownames(c52) <- c("Between men diabetes rate and proportion of calories from animal protein", "Between women diabetes rate and proportion of calories from animal protein")
...
tab_model(
  lm_diabm_prop_animal_prot_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabw_prop_animal_prot_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from animal protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabm_prop_plant_prot,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_diabw_prop_plant_prot,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c53) <- c("Between men diabetes rate and proportion of calories from plant protein", "Between women diabetes rate and proportion of calories from plant protein")
...
tab_model(
  lm_diabm_prop_plant_prot_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabw_prop_plant_prot_clust1,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
rownames(c54) <- c("Between men diabetes rate and proportion of calories from plant protein", "Between women diabetes rate and proportion of calories from plant protein")
...
tab_model(
  lm_diabm_prop_plant_prot_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabw_prop_plant_prot_clust2,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
rownames(c55) <- c("Between men diabetes rate and proportion of calories from plant protein", "Between women diabetes rate and proportion of calories from plant protein")
...
tab_model(
  lm_diabm_prop_plant_prot_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabw_prop_plant_prot_clust3,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from plant protein"),
  CSS = list(
    css.width = "500px",
...
tab_model(
  lm_diabm_prop_carbs,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from carbs"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_diabw_prop_carbs,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from carbs"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c56) <- c("Between men diabetes rate and proportion of calories from carbs", "Between women diabetes rate and proportion of calories from carbs")
...
rownames(c57) <- c("Between men diabetes rate and proportion of calories from carbs", "Between women diabetes rate and proportion of calories from carbs")
...
rownames(c58) <- c("Between men diabetes rate and proportion of calories from carbs", "Between women diabetes rate and proportion of calories from carbs")
...
tab_model(
  lm_diabm_prop_fat,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for men vs proportion of calories from fat"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
tab_model(
  lm_diabw_prop_fat,
  show.ci = FALSE, show.stat = TRUE, show.se = TRUE,
  dv.labels = c("Diabetes rate for women vs proportion of calories from fat"),
  CSS = list(
    css.width = "500px",
    css.centeralign = "text-align: left;",
    css.firsttablecol = "font-weight: bold;",
...
rownames(c59) <- c("Between men diabetes rate and proportion of calories from fat", "Between women diabetes rate and proportion of calories from fat")
...
rownames(c60) <- c("Between men diabetes rate and proportion of calories from fat", "Between women diabetes rate and proportion of calories from fat")
...
rownames(c61) <- c("Between men diabetes rate and proportion of calories from fat", "Between women diabetes rate and proportion of calories from fat")
...
kbl(cl_all3,
  caption = "**Table 9** : Means for each cluster",
  align = c("cccccc")
) %>%
  kable_classic(full_width = T, html_font = "Cambria") %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"))
