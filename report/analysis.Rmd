...
Since the units of the variables "calories consumed from animal protein/plant protein/carbs/fat" are on a per capita basis, we think that including the GDP per capita in the analysis could improve the results. Additionally, we want to find out if including the proportions of the calories consumed from different macronutrients on the total calories affects our analysis. 
...
With these new metrics introduced, we will plot again these relationships.
...
```{r}
##############################################
##### GDP - calories from animal protein #####
##############################################
...
#proportion with GDP per person
ggplot() + 
  geom_line(data = GDP_diabetes_cal, aes(x = gdp_per_person, y = proportion_animal_prot), color = "red") +  
  labs(x = "GDP per capita", y= "Calories from animal protein")

#GDP per person  ~ proportion animal protein
...
#cluster 1 - proportion animal protein
...
#cluster 2 - proportion animal protein
...
#cluster 3 - proportion animal protein
...
```{r}
#############################################
##### GDP - calories from plant protein #####
#############################################
...
#GDP per person  ~ proportion plant protein
...
#cluster 1 - proportion plant protein
...
#cluster 2 - proportion plant protein
...
#cluster 3 - proportion plant protein
...
#GDP per person  ~ proportion carbs
