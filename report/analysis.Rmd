...
leaflet(SHP_0) %>%
  ...
  opacity = .6)
```
We can therefore see that the first cluster is more located in the north and center of Europe while the second cluster is more towards the extremities of Europe (West and East).

We then plot the cluster with the different variables to see their characteristics. 
<br><br>
```{r, warning=FALSE}
