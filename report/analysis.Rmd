...
This time, the correlation is higher and the variable's estimate as a parameter is very significant ! Maybe the correlation can improve by considering proportion of calories instead of the calorie count. We can test with both the average GDP and GDP per capita of a country.

```{r}
#Average GDP - proportion --> take out ?
...
These 2 variables are not correlated at all.
...
In general, we cannot conclude that there is a correlation between the wealth of a country and its animal protein.
