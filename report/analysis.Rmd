...
The trend is verified here with a negative trend for both men women, we can also see that the relationship is stronger for women. The linear regression does not indicate any relation since the parameters are not significant. We will now see if there is a relationship between diabetes and animal protein for each cluster.
