...
#FAUT ENLEVER CETTE PREMIERE PARTIE PARCE QUE LES PARAMETRES AVEC LES CALORIES SONT A 0 ?
```{r}
...
pie1 <- pie(slices, labels = lbls,col=rainbow(length(lbls)), main="Consumption Pattern of countries in Cluster 1")
...
lbls <- paste(lbls, pct) # add percents to labels
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie2 <- pie(slices, labels = lbls,col=rainbow(length(lbls)), main="Consumption Pattern of countries in Cluster 2")
...
lbls <- paste(lbls, pct) # add percents to labels
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie3 <- pie(slices, labels = lbls,col=rainbow(length(lbls)), main="Consumption Pattern of countries in Cluster 3")
