...
pie(slices, labels = lbls,col=rainbow(length(lbls)), main="Consumption Pattern of countries in Cluster 1")
...
lbls <- paste(lbls, pct) # add percents to labels
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices, labels = lbls,col=rainbow(length(lbls)), main="Consumption Pattern of countries in Cluster 2")
...
lbls <- paste(lbls, pct) # add percents to labels
lbls <- paste(lbls,"%",sep="") # ad % to labels 
pie(slices, labels = lbls,col=rainbow(length(lbls)), main="Consumption Pattern of countries in Cluster 3")
