...
As mentioned in the first point, countries with a higher GDP have a lower diabetes rate which could potentially be explained by the consumption of fewer calories. Furthermore, we know from the EDA part that richer countries consume more fat on average but what is the real relationship between calorie consumption and GDP?
...
parler des proportions par rapport aux total calories + peut-être qu'on doit regarder le PIB par personne pour que les graphiques fassent du sens + regarder les échelles dans EDA
